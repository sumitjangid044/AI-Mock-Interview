...
function Feedback({ params }) {
    ...
    const GetFeedback = async () => {
        const res = await fetch(`/api/feedback/${params.interviewId}`);
        ...
        <div className="p-10">
            ...
            {feedbackList?.length == 0 ?
                ...
                <>
                    ...
                    <h2 className="text-sm text-gray-700 my-3">
                        Find below interview question with correct answer and feedback
                    </h2>
